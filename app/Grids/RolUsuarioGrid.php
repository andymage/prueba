...
class RolUsuarioGrid extends Grid implements RolUsuarioGridInterface
{
    /**
     ...
     * @var string
     */
    protected $name = 'Lista de roles asignados a usuarios';
    ...
    protected $buttonsToGenerate = [
        'asignar', 'ver', 'eliminar', 'actualizar', 'export'
    ];
    ...
    */
    ...
    public function setRoutes()
    {
        ...
        $this->sortRouteName = 'rolesusuario.index';
        $this->searchRoute = 'rolesusuario.index';

        // crud support
        $this->indexRouteName = 'rolesusuario.index';
        $this->createRouteName = 'rolesusuario.create';
        $this->viewRouteName = 'rolesusuario.show';
        $this->deleteRouteName = 'rolesusuario.destroy';
    }
    ...
    public function configureButtons()
    {
        ...
        $this->makeCustomButton([
            ...
            'url' => function($gridName, $gridItem) {
                return route('rolesusuario.update', ['id' => $gridItem->id]);
            },
            // where to the left or right with respect to other buttons would it be displayed. Higher means it will slide over to the far left, 
            // and lower means it will slide over to the far right. Its actually a sort run over the collection of buttons, and this argument
            // passed in the callback as an arg. Defaults to null
        ...
        $this->makeCustomButton([
            ...
            // it accepts both a string and a callbac. See the scenarios below
            'url' => function($gridName, $gridItem) {
                return route('rolesusuario.show', ['id' => $gridItem->id]);
            },
            // where to the left or right with respect to other buttons would it be displayed. Higher means it will slide over to the far left, 
            // and lower means it will slide over to the far right. Its actually a sort run over the collection of buttons, and this argument
            // passed in the callback as an arg. Defaults to null
        ...
        $this->makeCustomButton([
            ...
            // it accepts both a string and a callbac. See the scenarios below
            'url' => function($gridName, $gridItem) {
                return route('rolesusuario.destroy', ['id' => $gridItem->id]);
            },
            // where to the left or right with respect to other buttons would it be displayed. Higher means it will slide over to the far left, 
            // and lower means it will slide over to the far right. Its actually a sort run over the collection of buttons, and this argument
            // passed in the callback as an arg. Defaults to null
